        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('admins/')}}" class="nav-link active" style="color:white">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Liste des inscrits</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admins/create')}}" class="nav-link" style="color:white">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter un vaccin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admins/showVaccin')}}" class="nav-link" style="color:white">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listes des Vaccins</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admins/viewContact')}}" class="nav-link" style="color:white">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listes des Contacts</p>
                </a>
              </li>
            </ul>
          </li>
